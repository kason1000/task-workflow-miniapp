        ...
        <div style={{
          ...
          <div style={{
            ...
            <ul style={{ 
              ...
              <li style={{ marginBottom: '4px' }}>Send 1 photo = 1 new task</li>
              <li style={{ marginBottom: '4px' }}>Send 5 photos = 5 new tasks</li>
          ...
          <div style={{
            ...
            <span style={{ opacity: 0.9 }}>
              Go to your bot chat and send photos to get started!
            </span>
          </div>
        </div>
      </div>
